...
namespace OAC {
  namespace Matrix {
    std::vector<std::vector<double>> transpose(std::vector<std::vector<double>> *currentMatrix);
    ...
    std::vector<std::vector<double>> cacheMultiply(std::vector<std::vector<double>> *matrix1,
                                                   std::vector<std::vector<double>> *matrix2);
  }  // namespace Matrix
}  // namespace OAC
